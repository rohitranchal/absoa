...
(2, 'localhost:4102','Payment', 5.0, 4.0, 'credit card', 'localhost', 4102, 'http://localhost:4102', '{}', -1, 'scenarios/payment'),
(3, 'localhost:4103','Seller', 5.0, 4.0, 'email', 'localhost', 4103, 'http://localhost:4103', '{}', -1, 'scenarios/seller'),
