	...
	public String bookService(String input) {
		...
		try {
			...
			if (abSessionObject != null) {
				...
				// Connect to flight service and send the active bundle
				if (input.equals("flight")) {
					System.out.println("Send Active Bundle to Flight Service");
					...
					ABReturn = service.flightService("Alice");
					System.out
							.println("Active Bundle returned from Flight Service");
